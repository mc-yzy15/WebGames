...
const SnakeGame = (() => {
    ...
    function initDOM(container) {
        ...
        highScoreElement = container.querySelector('#highScore');
        startBtn = container.querySelector('#startButton');
        pauseBtn = container.querySelector('#pauseButton');
        upBtn = container.querySelector('#up');
        leftBtn = container.querySelector('#left');
        rightBtn = container.querySelector('#right');
        downBtn = container.querySelector('#down');
    }
